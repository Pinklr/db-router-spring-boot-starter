package cn.zly.middleware.db.router.aspect;


import cn.zly.middleware.db.router.annotation.DBRouter;
...
public class DBRouterJoinPoint {
    ...
    private DbRouterProperties dbRouterConfig;

    private IDBRouterStrategy dbRouterStrategy;

    public DBRouterJoinPoint(DbRouterProperties dbRouterConfig, IDBRouterStrategy dbRouterStrategy) {
        this.dbRouterConfig = dbRouterConfig;
        this.dbRouterStrategy = dbRouterStrategy;
    }

    @Pointcut("@annotation(cn.zly.middleware.db.router.annotation.DBRouter)")
